...
L["/dragonui  |  /dragonui legacy for classic options"] = "/dragonui  |  /dragonui legacy para opciones clásicas"
...
L["Use /dragonui legacy to open the classic AceConfig options."] = "Usa /dragonui legacy para abrir las opciones clásicas de AceConfig."
